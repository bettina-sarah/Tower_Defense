...
class Vue:
    ...
    def create_canvases(self, canvas1_height, canvas2_height):
        ...
        self.menu_choix_tours = tk.Frame(self.canvas2)  # Frame menu choix tours
        self.menu_amelioration_tours = tk.Frame(self.canvas2)  # Frame menu amelioration tours
    ...
    def show_main_menu(self):
        self.canvas2.itemconfigure(self.monMenuAmelioration, state='hidden')  # Hide submenu
        self.canvas2.itemconfigure(self.monMenuChoixTours, state='normal')  # Display main menu

    def show_submenu(self):
        self.canvas2.itemconfigure(self.monMenuAmelioration, state='hidden')  # Hide main menu
        self.canvas2.itemconfigure(self.monMenuChoixTours, state='normal')  # Display submenu
